import { buildBakeScene } from './bake-scenes.mjs';
...
export class WorkshopView {
  constructor(canvas, state) {
    ...
    if (this.level.sceneFamily === 'bake') this.extra = buildBakeScene(this);
    else if (this.level.sceneFamily === 'book') this.extra = buildBookScene(this);
