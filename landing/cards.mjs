...
export function seasonCardsMarkup(seasons,releaseUrl='../dist/') {
  return seasons.map(season=>{
    ...
    const art=bookArtwork(season.openingId)||stationArtwork(season.openingId)||postArtwork(season.openingId)||gardenArtwork(season.openingId)||seasonArtwork(season.openingId)||'';
