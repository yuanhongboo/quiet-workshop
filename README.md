...
三季可切换，每关自动保存；各季拥有独立收藏。重玩关卡不会丢失已获得的成果。第二、三季支持四面环看和近距离观察，点击清洁清单可定位部位和剩余污渍。

[固定游戏首页](https://yuanhongboo.github.io/orbit-breaker/quiet-workshop/) · [最新验证记录](qa/season-three-v0.5.0/REPORT.md)
...
三季默认播放已确认的原创钢琴曲《光落在窗台》。点击开始或继续后播放；右上角音符按钮只控制背景音乐，扬声器控制全部声音。音乐以录音流式播放，跨季保留位置，暂停和切到后台时停止；偏好保存在当前浏览器，擦洗和浇水时会自动降低音乐音量。
