...
| 第三季 | 海边来信 | 三章九关，恢复灯塔旁的邮局，每章回望成果 | 0.5.0 已发布 |
| 第四季 | 山间小站 | 三章九关，修复山间站台，迎接小火车归来 | 0.6.0 已发布 |
| 第五季 | 风吹书页 | 三章九关，修好旧书屋，让往日风景映在墙上 | 0.7.0 已发布 |
| 第六季 | 晚风面包房 | 三章九关，修好工具、揉圆面团、迎接面包出炉 | 0.8.0 已发布 |

六季可切换，每关自动保存；各季拥有独立收藏。重玩关卡不会丢失已获得的成果。第二至六季支持四面环看和近距离观察，点击清洁清单可定位部位和剩余污渍。

[固定游戏首页](https://yuanhongboo.github.io/orbit-breaker/quiet-workshop/) · [最新验证记录](qa/season-six-v0.8.0/REPORT.md)
...
六季默认播放已确认的原创钢琴曲《光落在窗台》。点击开始或继续后播放；右上角音符按钮只控制背景音乐，扬声器控制全部声音。音乐以录音流式播放，跨季保留位置，暂停和切到后台时停止；偏好保存在当前浏览器，擦洗和浇水时会自动降低音乐音量。
...
- [第六季设计](docs/season-six.md)：工具修复、面团形变与晚风出炉。
- [第五季设计](docs/season-five.md)：书册修复、机械小物和故事投影。
- [第四季设计](docs/season-four.md)：山间小站的车站、轨道与列车归来。
